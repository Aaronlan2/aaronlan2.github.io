...
const precreatedHeightmaps = {
  "africa-centric": {id: 0, name: "非洲"},
  arabia: {id: 1, name: "阿拉伯"},
  atlantics: {id: 2, name: "大西洋"},
  britain: {id: 3, name: "英国"},
  caribbean: {id: 4, name: "加勒比海"},
  "east-asia": {id: 5, name: "东亚"},
  eurasia: {id: 6, name: "欧亚大陆"},
  europe: {id: 7, name: "欧洲"},
  "europe-accented": {id: 8, name: "欧洲(小)"},
  ...
  "us-centric": {id: 19, name: "世界(美国为中心)"},
  "us-mainland": {id: 20, name: "美国本土"},
  world: {id: 21, name: "世界(非洲为中心)"},
  "world-from-pacific": {id: 22, name: "世界(太平洋为中心)"}
};
