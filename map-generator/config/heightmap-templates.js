...
const heightmapTemplates = (function () {
  ...
  const fractious = `Hill 12-15 50-80 5-95 5-95
    ...
    return {
      ...
      highIsland: {id: 1, name: "高岛", template: highIsland, probability: 19},
      ...
      shattered: {id: 10, name: "破碎", template: shattered, probability: 7},
      taklamakan: {id: 11, name: "塔克拉玛干", template: taklamakan, probability: 1},
      oldWorld: {id: 12, name: "旧世界", template: oldWorld, probability: 8},
