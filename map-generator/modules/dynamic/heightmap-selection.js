...
function insertHtml() {
  ...
  const heightmapSelectionHtml = /* html */ `<div id="heightmapSelection" class="dialog stable">
    <div class="heightmap-selection">
      <section data-tip="选择生成模板 - 模板提供独特但看起来相似的地图">
        <header><h1>高程图模板</h1></header>
        <div class="heightmap-selection_container"></div>
      </section>
      <section data-tip="选择预先创建的高程图 - 对于每个地图都是相同的">
        <header><h1>预创建的高程图</h1></header>
        <div class="heightmap-selection_container"></div>
      </section>
      <section>
        ...
        <div class="heightmap-selection_options">
          <div>
            ...
            <div>
              ...
              <label data-tip="绘制水单元格的高度" for="heightmapSelectionRenderOcean" class="checkbox-label">渲染海洋高度</label>
            </div>
            <div data-tip="用于高程图预览的颜色方案">
              颜色方案
          ...
          <div>
            ...
            <button data-tip="打开图片转换器" data-tool="imageConverter" id="heightmapSelectionImportHeightmap">导入高程图</button>
          </div>
        </div>
      </section>
    </div>
